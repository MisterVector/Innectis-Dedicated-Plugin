...
) ENGINE=MyISAM AUTO_INCREMENT=94875 DEFAULT CHARSET=utf8;
...
CREATE TABLE `chestlog` (
  ...
  KEY `date` (`date`),
  KEY `name` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=78045 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=13462 DEFAULT CHARSET=latin1;
