...
) ENGINE=MyISAM AUTO_INCREMENT=36723 DEFAULT CHARSET=utf8;
...
CREATE TABLE `chestlog` (
  ...
  KEY `date` (`date`),
  KEY `name` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=77574 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=8930 DEFAULT CHARSET=latin1;
