...
MySQL - 5.5.25a : Database - otakucraft
*********************************************************************
*/
...
) ENGINE=MyISAM AUTO_INCREMENT=51403 DEFAULT CHARSET=utf8;
...
CREATE TABLE `chestlog` (
  ...
  KEY `date` (`date`),
  KEY `name` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=77595 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=10301 DEFAULT CHARSET=latin1;
...
CREATE TABLE `players` (
  ...
  `shopnotification` tinyint(1) DEFAULT '1',
  `showdeathmsg` tinyint(4) DEFAULT '1',
  `backpack` text,
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
